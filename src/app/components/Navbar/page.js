...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/95 backdrop-blur-md sticky top-0 z-30 border-b border-gray-100 shadow-sm">
      <div className="px-3 sm:px-4 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">

          {/* LOGO — hidden on mobile (sidebar has it), visible on desktop */}
          <Link
            href="/"
            className="hidden md:flex items-center gap-2 text-lg font-bold text-indigo-600 hover:text-indigo-700 transition-colors"
          >
          ...
          <div className="flex items-center gap-2">
            {user ? (
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-60 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden z-50">
                    {/* User Info */}
