    ...
    <>
      ...
      <section id="get-started" className="py-16 sm:py-20 bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          >
            <button className="inline-flex items-center justify-center gap-2 bg-yellow-400 text-indigo-900 px-10 py-5 rounded-full font-bold hover:bg-yellow-300 transition-all shadow-2xl hover:scale-105 w-full sm:w-auto" style={{fontSize:'12px'}}>
